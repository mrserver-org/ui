...
`,
  ...
  win
    .querySelector(".notes-content-text")
    .style.setProperty("white-space", whitespaceStyle, "important");
  win.querySelector(".notes-content-text").style.fontSize =
    `${getAppSetting("notes", "font-size", 14)}px`;
