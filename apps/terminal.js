function terminal() {
    const win = createWindow('Terminal', `<div id="terminal" style="background:transparent;position:absolute;left:0;right:0;width:100%;height:100%;"></div>`);
    ...
    const ws = new WebSocket(`${protocol}://${host}:9091/api/terminal`);
    let resizeObserver;
